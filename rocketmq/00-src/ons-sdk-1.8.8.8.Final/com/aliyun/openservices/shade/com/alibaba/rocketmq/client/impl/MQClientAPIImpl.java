...
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.body.CreateOrUpdateTopicBody;
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.body.CreateTopicListRequestBody;
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.body.GetConsumerStatusBody;
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.body.GetRemoteClientConfigBody;
...
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.header.CreateTopicListRequestHeader;
...
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.header.GetTopicConfigRequestHeader;
...
import com.aliyun.openservices.shade.com.alibaba.rocketmq.common.protocol.header.namesrv.DeleteTopicInNamesrvRequestHeader;
...
public class MQClientAPIImpl implements NameServerUpdateCallback {
    ...
    public TopicRouteDatas getTopicRouteInfoFromNameServer(final List<String> topics, final long timeoutMillis)
        ...
        switch (response.getCode()) {
            case ResponseCode.SUCCESS: {
                if (response.getBody() != null) {
                    return TopicRouteDatas.decode(response.getBody(), TopicRouteDatas.class);
                }
            }
            default:
                break;
        ...
        switch (response.getCode()) {
            case ResponseCode.SUCCESS: {
                if (null != response.getByteArrayBody()) {
                    return ResetOffsetBody.decode(response.getByteArrayBody(), ResetOffsetBody.class).getOffsetTable();
                }
                break;
            }
    ...
    public ConsumeMessageDirectlyResult consumeMessageDirectly(final String addr,
        ...
        switch (response.getCode()) {
            case ResponseCode.SUCCESS: {
                if (response.getBody() != null) {
                    return ConsumeMessageDirectlyResult.decode(response.getBody(),
