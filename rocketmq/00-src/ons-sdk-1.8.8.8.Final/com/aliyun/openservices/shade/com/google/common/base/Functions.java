...
/**
 * Static utility methods pertaining to {@code com.aliyun.openservices.shade.com.google.common.base.Function} instances; see that
 ...
 * <a href="https://github.com.aliyun.openservices.shade.com.google/guava/wiki/FunctionalExplained">the use of {@code
 * Function}</a>.
 *
 * @author Mike Bostock
 * @author Jared Levy
...
public final class Functions {
   ...
   *
   * <p>Note: if {@code map} is a {@link com.aliyun.openservices.shade.com.google.common.collect.BiMap BiMap} (or can be one), you
   * can use {@link com.aliyun.openservices.shade.com.google.common.collect.Maps#asConverter Maps.asConverter} instead to get a
