...
package com.aliyun.openservices.shade.com.google.common.cache;
...
import static com.aliyun.openservices.shade.com.google.common.cache.CacheBuilder.NULL_TICKER;
import static com.aliyun.openservices.shade.com.google.common.cache.CacheBuilder.UNSET_INT;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.MoreExecutors.directExecutor;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import com.aliyun.openservices.shade.com.google.common.annotations.GwtCompatible;
import com.aliyun.openservices.shade.com.google.common.annotations.GwtIncompatible;
import com.aliyun.openservices.shade.com.google.common.annotations.VisibleForTesting;
import com.aliyun.openservices.shade.com.google.common.base.Equivalence;
...
import com.aliyun.openservices.shade.com.google.common.base.Ticker;
import com.aliyun.openservices.shade.com.google.common.cache.AbstractCache.SimpleStatsCounter;
import com.aliyun.openservices.shade.com.google.common.cache.AbstractCache.StatsCounter;
import com.aliyun.openservices.shade.com.google.common.cache.CacheBuilder.NullListener;
import com.aliyun.openservices.shade.com.google.common.cache.CacheBuilder.OneWeigher;
import com.aliyun.openservices.shade.com.google.common.cache.CacheLoader.InvalidCacheLoadException;
import com.aliyun.openservices.shade.com.google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import com.aliyun.openservices.shade.com.google.common.collect.AbstractSequentialIterator;
...
import com.aliyun.openservices.shade.com.google.common.collect.Iterators;
...
import com.aliyun.openservices.shade.com.google.common.primitives.Ints;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.ExecutionError;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.Futures;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.ListenableFuture;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.SettableFuture;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.UncheckedExecutionException;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.Uninterruptibles;
import com.aliyun.openservices.shade.com.google.j2objc.annotations.Weak;
 ...
 *
 * @author Charles Fry
 * @author Bob Lee ({@code com.aliyun.openservices.shade.com.google.common.collect.MapMaker})
...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
  ...
  long longSize() {
    ...
    long sum = 0;
    for (int i = 0; i < segments.length; ++i) {
      sum += Math.max(0, segments[i].count); // see https://github.com.aliyun.openservices.shade.com.google/guava/issues/2108
    }
    return sum;
  }
