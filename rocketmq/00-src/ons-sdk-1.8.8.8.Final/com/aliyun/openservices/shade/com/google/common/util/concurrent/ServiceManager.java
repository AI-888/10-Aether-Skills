 ...
 * the License.
 */
package com.aliyun.openservices.shade.com.google.common.util.concurrent;

import static com.aliyun.openservices.shade.com.google.common.base.Preconditions.checkArgument;
import static com.aliyun.openservices.shade.com.google.common.base.Preconditions.checkNotNull;
import static com.aliyun.openservices.shade.com.google.common.base.Preconditions.checkState;
import static com.aliyun.openservices.shade.com.google.common.base.Predicates.equalTo;
import static com.aliyun.openservices.shade.com.google.common.base.Predicates.in;
import static com.aliyun.openservices.shade.com.google.common.base.Predicates.instanceOf;
import static com.aliyun.openservices.shade.com.google.common.base.Predicates.not;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.MoreExecutors.directExecutor;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State.FAILED;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State.NEW;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State.RUNNING;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State.STARTING;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State.STOPPING;
import static com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State.TERMINATED;
import static java.util.concurrent.TimeUnit.MILLISECONDS;

import com.aliyun.openservices.shade.com.google.common.annotations.Beta;
import com.aliyun.openservices.shade.com.google.common.annotations.GwtIncompatible;
import com.aliyun.openservices.shade.com.google.common.base.Function;
import com.aliyun.openservices.shade.com.google.common.base.MoreObjects;
import com.aliyun.openservices.shade.com.google.common.base.Stopwatch;
import com.aliyun.openservices.shade.com.google.common.collect.Collections2;
import com.aliyun.openservices.shade.com.google.common.collect.ImmutableCollection;
import com.aliyun.openservices.shade.com.google.common.collect.ImmutableList;
import com.aliyun.openservices.shade.com.google.common.collect.ImmutableMap;
import com.aliyun.openservices.shade.com.google.common.collect.ImmutableMultimap;
import com.aliyun.openservices.shade.com.google.common.collect.ImmutableSet;
import com.aliyun.openservices.shade.com.google.common.collect.ImmutableSetMultimap;
import com.aliyun.openservices.shade.com.google.common.collect.Lists;
import com.aliyun.openservices.shade.com.google.common.collect.Maps;
import com.aliyun.openservices.shade.com.google.common.collect.MultimapBuilder;
import com.aliyun.openservices.shade.com.google.common.collect.Multimaps;
import com.aliyun.openservices.shade.com.google.common.collect.Multiset;
import com.aliyun.openservices.shade.com.google.common.collect.Ordering;
import com.aliyun.openservices.shade.com.google.common.collect.SetMultimap;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.ListenerCallQueue.Callback;
import com.aliyun.openservices.shade.com.google.common.util.concurrent.Service.State;
import com.aliyun.openservices.shade.com.google.errorprone.annotations.CanIgnoreReturnValue;
import com.aliyun.openservices.shade.com.google.j2objc.annotations.WeakOuter;
