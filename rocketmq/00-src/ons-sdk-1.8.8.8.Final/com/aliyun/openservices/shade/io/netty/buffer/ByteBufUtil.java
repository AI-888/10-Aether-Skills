...
public final class ByteBufUtil {
    ...
    static {
        String allocType = SystemPropertyUtil.get(
                "com.aliyun.openservices.shade.io.netty.allocator.type", PlatformDependent.isAndroid() ? "unpooled" : "pooled");
        ...
        THREAD_LOCAL_BUFFER_SIZE = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.threadLocalDirectBufferSize", 0);
