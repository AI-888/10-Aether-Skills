...
import com.aliyun.openservices.shade.io.netty.util.NettyRuntime;
...
import com.aliyun.openservices.shade.io.netty.util.internal.ThreadExecutorMap;
...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    static {
        ...
        if (SystemPropertyUtil.contains("com.aliyun.openservices.shade.io.netty.allocation.cacheTrimIntervalMillis")) {
            logger.warn("-Dio.netty.allocation.cacheTrimIntervalMillis is deprecated," +
                    " use -Dio.netty.allocator.cacheTrimIntervalMillis");

            if (SystemPropertyUtil.contains("com.aliyun.openservices.shade.io.netty.allocator.cacheTrimIntervalMillis")) {
                // Both system properties are specified. Use the non-deprecated one.
                DEFAULT_CACHE_TRIM_INTERVAL_MILLIS = SystemPropertyUtil.getLong(
                        "com.aliyun.openservices.shade.io.netty.allocator.cacheTrimIntervalMillis", 0);
            } else {
                DEFAULT_CACHE_TRIM_INTERVAL_MILLIS = SystemPropertyUtil.getLong(
                        "com.aliyun.openservices.shade.io.netty.allocation.cacheTrimIntervalMillis", 0);
            }
        } else {
            DEFAULT_CACHE_TRIM_INTERVAL_MILLIS = SystemPropertyUtil.getLong(
                    "com.aliyun.openservices.shade.io.netty.allocator.cacheTrimIntervalMillis", 0);
        ...
        DEFAULT_USE_CACHE_FOR_ALL_THREADS = SystemPropertyUtil.getBoolean(
                "com.aliyun.openservices.shade.io.netty.allocator.useCacheForAllThreads", true);

        DEFAULT_DIRECT_MEMORY_CACHE_ALIGNMENT = SystemPropertyUtil.getInt(
                "com.aliyun.openservices.shade.io.netty.allocator.directMemoryCacheAlignment", 0);

        // Use 1023 by default as we use an ArrayDeque as backing storage which will then allocate an internal array
        // of 1024 elements. Otherwise we would allocate 2048 and only use 1024 which is wasteful.
        DEFAULT_MAX_CACHED_BYTEBUFFERS_PER_CHUNK = SystemPropertyUtil.getInt(
                "com.aliyun.openservices.shade.io.netty.allocator.maxCachedByteBuffersPerChunk", 1023);
    ...
    /**
     * Default number of heap arenas - System Property: com.aliyun.openservices.shade.io.netty.allocator.numHeapArenas - default 2 * cores
     */
    ...
    /**
     * Default number of direct arenas - System Property: com.aliyun.openservices.shade.io.netty.allocator.numDirectArenas - default 2 * cores
     */
    ...
    /**
     * Default thread caching behavior - System Property: com.aliyun.openservices.shade.io.netty.allocator.useCacheForAllThreads - default true
     */
    ...
    /**
     * Default prefer direct - System Property: com.aliyun.openservices.shade.io.netty.noPreferDirect - default false
     */
