 ...
 * {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} message = {@link com.aliyun.openservices.shade.io.netty.buffer.Unpooled}.wrappedBuffer(header, body);
 *
 * // Therefore, you can even create a composite by mixing a composite and an
 * // ordinary buffer.
 * {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} messageWithFooter = {@link com.aliyun.openservices.shade.io.netty.buffer.Unpooled}.wrappedBuffer(message, footer);
 *
 * // Because the composite is still a {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf}, you can access its content
 ...
 * {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} b = {@link com.aliyun.openservices.shade.io.netty.buffer.Unpooled}.buffer(4);
 *
