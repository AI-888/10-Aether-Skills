 ...
 * <br>
 * Usage example (given that the {@code haystack} is a {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} containing "ABCD" and the
...
public abstract class AbstractMultiSearchProcessorFactory implements MultiSearchProcessorFactory {
     ...
     * Every byte of {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} is processed only once, sequentually, regardles of
