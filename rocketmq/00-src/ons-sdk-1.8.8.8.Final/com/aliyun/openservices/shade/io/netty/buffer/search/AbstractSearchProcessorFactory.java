 ...
 * the License.
 */
package com.aliyun.openservices.shade.io.netty.buffer.search;
 ...
 * <br>
 * <b>Note:</b> implementations of {@link SearchProcessor} scan the {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} sequentially,
 * one byte after another, without doing any random access. As a result, when using {@link SearchProcessor}
 * with such methods as {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf#forEachByte}, these methods return the index of the last byte
 * of the found byte sequence within the {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} (which might feel counterintuitive,
 * and different from {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBufUtil#indexOf} which returns the index of the first byte
 * of found sequence).
 * <br>
 ...
 * {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf}s). A new instance should be created with {@link AbstractSearchProcessorFactory} for
 ...
 * <br>
 * Example (given that the {@code haystack} is a {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} containing "ABABAB" and
...
public abstract class AbstractSearchProcessorFactory implements SearchProcessorFactory {
     ...
     * {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} on which the search is peformed ({@code O(|haystack|)}).
     * Every byte of {@link com.aliyun.openservices.shade.io.netty.buffer.ByteBuf} is processed only once, sequentually.
     *
