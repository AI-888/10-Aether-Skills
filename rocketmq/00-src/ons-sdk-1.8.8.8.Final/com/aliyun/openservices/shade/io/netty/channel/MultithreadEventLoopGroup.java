...
import com.aliyun.openservices.shade.io.netty.util.concurrent.EventExecutorChooserFactory;
...
public abstract class MultithreadEventLoopGroup extends MultithreadEventExecutorGroup implements EventLoopGroup {
    ...
    static {
        DEFAULT_EVENT_LOOP_THREADS = Math.max(1, SystemPropertyUtil.getInt(
                "com.aliyun.openservices.shade.io.netty.eventLoopThreads", NettyRuntime.availableProcessors() * 2));
