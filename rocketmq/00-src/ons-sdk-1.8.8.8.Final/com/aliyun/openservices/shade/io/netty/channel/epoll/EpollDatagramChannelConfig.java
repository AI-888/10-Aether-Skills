...
public final class EpollDatagramChannelConfig extends EpollChannelConfig implements DatagramChannelConfig {
    ...
    /**
     * Set the maximum {@link com.aliyun.openservices.shade.io.netty.channel.socket.DatagramPacket} size. This will be used to determine if
     * {@code recvmmsg} should be used when reading from the underlying socket. When {@code recvmmsg} is used
     * we may be able to read multiple {@link com.aliyun.openservices.shade.io.netty.channel.socket.DatagramPacket}s with one syscall and so
    ...
    /**
     * Get the maximum {@link com.aliyun.openservices.shade.io.netty.channel.socket.DatagramPacket} size.
     */
