...
import com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State;
...
import com.aliyun.openservices.shade.io.netty.util.collection.IntObjectMap.PrimitiveEntry;
...
import com.aliyun.openservices.shade.io.netty.util.concurrent.UnaryPromiseNotifier;
...
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.CONNECTION_STREAM_ID;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_MAX_RESERVED_STREAMS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Error.INTERNAL_ERROR;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Error.PROTOCOL_ERROR;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Error.REFUSED_STREAM;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Exception.closedStreamError;
...
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.CLOSED;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.HALF_CLOSED_LOCAL;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.HALF_CLOSED_REMOTE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.IDLE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.OPEN;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.RESERVED_LOCAL;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Stream.State.RESERVED_REMOTE;
