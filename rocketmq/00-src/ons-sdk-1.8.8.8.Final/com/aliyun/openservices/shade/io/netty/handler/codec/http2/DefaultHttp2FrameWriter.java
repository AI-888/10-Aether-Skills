...
package com.aliyun.openservices.shade.io.netty.handler.codec.http2;
...
import com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SimpleChannelPromiseAggregator;
import com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameWriter.Configuration;
import com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2HeadersEncoder.SensitivityDetector;
...
import static com.aliyun.openservices.shade.io.netty.buffer.Unpooled.directBuffer;
import static com.aliyun.openservices.shade.io.netty.buffer.Unpooled.unreleasableBuffer;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.CONTINUATION_FRAME_HEADER_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.DATA_FRAME_HEADER_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_MAX_FRAME_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.FRAME_HEADER_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.GO_AWAY_FRAME_HEADER_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.HEADERS_FRAME_HEADER_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.INT_FIELD_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_UNSIGNED_BYTE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_UNSIGNED_INT;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_WEIGHT;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MIN_WEIGHT;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.PING_FRAME_PAYLOAD_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.PRIORITY_ENTRY_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.PRIORITY_FRAME_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.PUSH_PROMISE_FRAME_HEADER_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.RST_STREAM_FRAME_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTING_ENTRY_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.WINDOW_UPDATE_FRAME_LENGTH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.isMaxFrameSizeValid;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.verifyPadding;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.writeFrameHeaderInternal;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Error.FRAME_SIZE_ERROR;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2Exception.connectionError;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.CONTINUATION;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.DATA;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.GO_AWAY;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.HEADERS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.PING;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.PRIORITY;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.PUSH_PROMISE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.RST_STREAM;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.SETTINGS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2FrameTypes.WINDOW_UPDATE;
...
import static com.aliyun.openservices.shade.io.netty.util.internal.ObjectUtil.checkPositiveOrZero;
