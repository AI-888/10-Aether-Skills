...
import com.aliyun.openservices.shade.io.netty.util.collection.CharObjectHashMap;
import com.aliyun.openservices.shade.io.netty.util.internal.UnstableApi;

import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.DEFAULT_HEADER_LIST_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_CONCURRENT_STREAMS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_HEADER_LIST_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_HEADER_TABLE_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MAX_INITIAL_WINDOW_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MIN_CONCURRENT_STREAMS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MIN_HEADER_LIST_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MIN_HEADER_TABLE_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.MIN_INITIAL_WINDOW_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.NUM_STANDARD_SETTINGS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_ENABLE_PUSH;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_HEADER_TABLE_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_INITIAL_WINDOW_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_MAX_CONCURRENT_STREAMS;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_MAX_FRAME_SIZE;
import static com.aliyun.openservices.shade.io.netty.handler.codec.http2.Http2CodecUtil.SETTINGS_MAX_HEADER_LIST_SIZE;
