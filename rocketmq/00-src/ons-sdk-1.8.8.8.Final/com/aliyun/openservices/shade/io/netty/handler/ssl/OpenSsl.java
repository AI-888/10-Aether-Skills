...
import com.aliyun.openservices.shade.io.netty.internal.tcnative.Library;
...
import static com.aliyun.openservices.shade.io.netty.handler.ssl.SslUtils.*;
...
public final class OpenSsl {
    ...
    static {
        ...
        if (SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.handler.ssl.noOpenSsl", false)) {
            ...
            try {
                Class.forName("com.aliyun.openservices.shade.io.netty.internal.tcnative.SSL", false, OpenSsl.class.getClassLoader());
            ...
            if (cause == null) {
                ...
                try {
                    String engine = SystemPropertyUtil.get("com.aliyun.openservices.shade.io.netty.handler.ssl.openssl.engine", null);
                    if (engine == null) {
                        ...
                        try {
                            ...
                            try {
                                boolean propertySet = SystemPropertyUtil.contains(
                                        "com.aliyun.openservices.shade.io.netty.handler.ssl.openssl.useKeyManagerFactory");
                                if (!IS_BORINGSSL) {
