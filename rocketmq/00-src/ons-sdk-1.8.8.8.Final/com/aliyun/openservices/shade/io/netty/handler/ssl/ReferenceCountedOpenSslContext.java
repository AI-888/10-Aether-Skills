...
import com.aliyun.openservices.shade.io.netty.internal.tcnative.CertificateVerifier;
import com.aliyun.openservices.shade.io.netty.internal.tcnative.SSL;
import com.aliyun.openservices.shade.io.netty.internal.tcnative.SSLContext;
import com.aliyun.openservices.shade.io.netty.internal.tcnative.SSLPrivateKeyMethod;
...
import static com.aliyun.openservices.shade.io.netty.handler.ssl.OpenSsl.DEFAULT_CIPHERS;
import static com.aliyun.openservices.shade.io.netty.handler.ssl.OpenSsl.availableJavaCipherSuites;
...
public abstract class ReferenceCountedOpenSslContext extends SslContext implements ReferenceCounted {
    ...
    private static final int DEFAULT_BIO_NON_APPLICATION_BUFFER_SIZE = Math.max(1,
            SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.handler.ssl.openssl.bioNonApplicationBufferSize",
                    2048));
    static final boolean USE_TASKS =
            SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.handler.ssl.openssl.useTasks", false);
