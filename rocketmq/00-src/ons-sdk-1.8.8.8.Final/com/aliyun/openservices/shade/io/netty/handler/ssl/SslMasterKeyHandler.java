...
import com.aliyun.openservices.shade.io.netty.util.internal.ReflectionUtil;
...
public abstract class SslMasterKeyHandler extends ChannelInboundHandlerAdapter {
     ...
     */
    public static final String SYSTEM_PROP_KEY = "com.aliyun.openservices.shade.io.netty.ssl.masterKeyHandler";
    ...
    */
     ...
     * The key and session identifier are forwarded to the log named 'com.aliyun.openservices.shade.io.netty.wireshark'.
     */
    ...
    /**
     * Record the session identifier and master key to the {@link InternalLogger} named <code>com.aliyun.openservices.shade.io.netty.wireshark</code>.
    ...
    private static final class WiresharkSslMasterKeyHandler extends SslMasterKeyHandler {
        ...
        private static final InternalLogger wireshark_logger =
                InternalLoggerFactory.getInstance("com.aliyun.openservices.shade.io.netty.wireshark");
