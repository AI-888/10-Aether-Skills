 ...
 * <ul>
 * <li> <tt>{@link com.aliyun.openservices.shade.io.netty.handler.traffic.TrafficCounter}</tt>: this class implements the counters needed by the
 ...
 *
 * <li> <tt>{@link com.aliyun.openservices.shade.io.netty.handler.traffic.AbstractTrafficShapingHandler}</tt>: this abstract class implements
 * the kernel of traffic shaping. It could be extended to fit your needs. Two classes are proposed as default
 * implementations: see {@link com.aliyun.openservices.shade.io.netty.handler.traffic.ChannelTrafficShapingHandler} and
 * {@link com.aliyun.openservices.shade.io.netty.handler.traffic.GlobalTrafficShapingHandler} respectively for Channel traffic shaping and
 ...
 * or by calling the <tt>configure</tt> method on the {@link com.aliyun.openservices.shade.io.netty.handler.traffic.AbstractTrafficShapingHandler}.
 ...
 * in {@link com.aliyun.openservices.shade.io.netty.handler.traffic.AbstractTrafficShapingHandler} or directly using the method <tt>configure</tt>
 * of {@link com.aliyun.openservices.shade.io.netty.handler.traffic.TrafficCounter}.</p>
 *
 * <p>Note that a new {@link com.aliyun.openservices.shade.io.netty.handler.traffic.ChannelTrafficShapingHandler} must be created
 * for each new channel, but only one {@link com.aliyun.openservices.shade.io.netty.handler.traffic.GlobalTrafficShapingHandler} must be created
 * for all channels.</p>
 *
