    ...
    public static final class NettyBlockHoundIntegration implements BlockHoundIntegration {
        ...
        public void applyTo(BlockHound.Builder builder) {
            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.channel.nio.NioEventLoop",
                    "handleLoopException"
            );

            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.channel.kqueue.KQueueEventLoop",
                    "handleLoopException"
            );

            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.channel.epoll.EpollEventLoop",
                    "handleLoopException"
            );

            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.util.HashedWheelTimer$Worker",
                    "waitForNextTick"
            );

            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.util.concurrent.SingleThreadEventExecutor",
                    "confirmShutdown"
            );

            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.handler.ssl.SslHandler",
                    "handshake"
            );
            ...
            builder.allowBlockingCallsInside(
                    "com.aliyun.openservices.shade.io.netty.util.concurrent.GlobalEventExecutor",
                    "takeTask");
