...
public final class InternalThreadLocalMap extends UnpaddedInternalThreadLocalMap {
    ...
    static {
        STRING_BUILDER_INITIAL_SIZE =
                SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.threadLocalMap.stringBuilder.initialSize", 1024);
        logger.debug("-Dio.netty.threadLocalMap.stringBuilder.initialSize: {}", STRING_BUILDER_INITIAL_SIZE);

        STRING_BUILDER_MAX_SIZE = SystemPropertyUtil.getInt("com.aliyun.openservices.shade.io.netty.threadLocalMap.stringBuilder.maxSize", 1024 * 4);
