...
final class PlatformDependent0 {
    ...
    private static Throwable explicitNoUnsafeCause0() {
        ...
        if (noUnsafe) {
            ...
            return new UnsupportedOperationException("sun.misc.Unsafe: unavailable (com.aliyun.openservices.shade.io.netty.noUnsafe)");
        }

        // Legacy properties
        String unsafePropName;
        if (SystemPropertyUtil.contains("com.aliyun.openservices.shade.io.netty.tryUnsafe")) {
            unsafePropName = "com.aliyun.openservices.shade.io.netty.tryUnsafe";
        } else {
    ...
    private static boolean explicitTryReflectionSetAccessible0() {
        ...
        return SystemPropertyUtil.getBoolean("com.aliyun.openservices.shade.io.netty.tryReflectionSetAccessible", javaVersion() < 9);
    }
