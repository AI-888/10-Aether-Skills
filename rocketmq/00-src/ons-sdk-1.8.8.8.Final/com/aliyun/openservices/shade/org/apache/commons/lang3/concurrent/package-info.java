 ...
 * All these classes implement the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentInitializer} interface which provides just a
 * single method:
 * </p>
 *
 * <pre>
 ...
 * By calling the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentInitializer#get() get()} method the object managed by the initializer can be obtained.
 * There are different implementations of the interface available
 * addressing various use cases:
 * </p>
 *
 * <p> {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConstantInitializer} is a very straightforward implementation of the <code>ConcurrentInitializer</code> interface:
 ...
 * </p>
 *
 * <p>The {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.LazyInitializer} class can be used to defer the creation of an object until it is actually used.
 ...
 * <code>LazyInitializer</code> declares an abstract {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.LazyInitializer#initialize() initialize()} method which we have to implement to create the messaging service object:</p>
 *
 * <pre>
 * <code>
 ...
 * </pre>
 *
 * <p>The {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.AtomicInitializer} class is very similar to <code>LazyInitializer</code>.
 ...
 * Again there is an abstract {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.AtomicInitializer#initialize() initialize()} method which has to be implemented by concrete subclasses in order to create and initialize the managed object.
 ...
 *
 * <p>With {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.AtomicSafeInitializer} there is yet another variant implementing the lazy initializing pattern.
 ...
 * The name &quot;Safe&quot; is derived from the fact that it implements an additional check which guarantees that the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.AtomicSafeInitializer#initialize() initialize()} method is called only once.
 ...
 *
 * <p>Another implementation of the <code>ConcurrentInitializer</code> interface is {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.BackgroundInitializer}.
 * It is again an abstract base class with an {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.BackgroundInitializer#initialize() initialize()} method that has to be defined by concrete subclasses.
 ...
 * </pre>
 *
 * <p> Related to <code>BackgroundInitializer</code> is the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.MultiBackgroundInitializer} class.
 ...
 * Then an arbitrary number of <code>BackgroundInitializer</code> objects is added using the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.MultiBackgroundInitializer#addInitializer(String, BackgroundInitializer)} method.
 * When adding an initializer a string has to be provided which is later used to obtain the result for this initializer.
 * When all initializers have been added the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.MultiBackgroundInitializer#start()} method is called.
 ...
 * <code>get()</code> returns an object of type {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}.
 ...
 * There is the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentUtils} class with a bunch of static utility methods.
 ...
 * </p>
 *
 * <p>The {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentUtils#extractCause(java.util.concurrent.ExecutionException)} method does this work for you.
 ...
 * Otherwise, an instance of {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentException} is created and initialized with the root cause
 ...
 * For users who prefer runtime exceptions in general there is also an {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)} method which behaves like <code>extractCause()</code>, but returns the unchecked exception {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentRuntimeException} instead.</p>
 *
 * <p>In addition to the <code>extractCause()</code> methods there are corresponding {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentUtils#handleCause(java.util.concurrent.ExecutionException)} and {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentUtils#handleCauseUnchecked(java.util.concurrent.ExecutionException)} methods.
 ...
 * </pre>
 *
 * <p>Using the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.ConcurrentUtils#initializeUnchecked(ConcurrentInitializer)} method, this becomes:</p>
 *
 * <pre>
 * <code>
 * ConcurrentInitializer&lt;MyClass&gt; initializer = ...;
 ...
 *
 * <p> With {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.BasicThreadFactory} Commons Lang has an implementation of <code>ThreadFactory</code> that works out of the box for many common use cases.
 ...
 * Instances of <code>BasicThreadFactory</code> are created and configured using the nested {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.BasicThreadFactory.Builder} class.
 ...
 * An instance can wrap another <code>ThreadFactory</code> implementation; this is achieved by calling the builder's {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory) wrappedFactory(ThreadFactory)} method.
 ...
 *
 * <p> {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.TimedSemaphore} allows restricted access to a resource in a given time frame.
 ...
 * Now multiple threads access the semaphore and call its {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.TimedSemaphore#acquire()} method.
 ...
 * </pre>
 *
 * <p>With the {@link com.aliyun.openservices.shade.org.apache.commons.lang3.concurrent.TimedSemaphore#setLimit(int)} method the number of permits allowed for a time frame can be changed.
